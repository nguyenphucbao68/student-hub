...
class InputProfileTechStackOnlyScreen extends StatefulWidget {
  const InputProfileTechStackOnlyScreen({super.key});

  @override
  State<InputProfileTechStackOnlyScreen> createState() =>
      _InputProfileTechStackOnlyScreenState();
}

class _InputProfileTechStackOnlyScreenState
    extends State<InputProfileTechStackOnlyScreen> {
