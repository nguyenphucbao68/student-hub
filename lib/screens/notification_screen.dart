...
import 'package:carea/model/notification.dart' as NotificationModel;
    ...
    await http.get(
      ...
      if (response.statusCode == 200) {
        ...
        if (data['result'] != null) {
          ...
          final Map<String, NotificationModel.Notification> notiMap = Map();
          // mappedData.forEach((element) {
          //   if (!notiMap.containsKey(element.title!)) {
          //     notiMap[element.title!] = element;
          //   }
          // });

          // mappedData = notiMap.values.toList();
