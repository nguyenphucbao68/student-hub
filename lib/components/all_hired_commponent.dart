...
import 'package:carea/commons/hired_widget.dart';
...
class AllHiredComponent extends StatefulWidget {
  Proposal? data = Proposal();
  AllHiredComponent({this.data});
  @override
  _AllHiredComponentState createState() => _AllHiredComponentState();
}

class _AllHiredComponentState extends State<AllHiredComponent> {
