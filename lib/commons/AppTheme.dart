...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.light(
        primary: appColorPrimary, primaryContainer: appColorPrimary).copyWith(error: Colors.red),
  ).copyWith(
